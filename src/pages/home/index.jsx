            ...
            <Row className="justify-content-center mt-5">
                ...
                <Col sm="8" md="8" className="pt-3">
                    <h1 style={{ color: "#4A4A4A", fontWeight: 600 }}>
                        Welcome to{" "}
                        <span className="text-logo ps-2">{text}</span>
                    </h1>
                    <p className="limited-width">
                        SalingChat is a simple chat application that allows you
            ...
            <Row className="justify-content-center mt-5">
                ...
                <Col md="6" className="mt-4">
                    ...
                    <p>
                        ...
                        Find meaning in every message.{" "}
                        <span style={{ fontWeight: "bold" }}>Distance</span>{" "}
                        isn&apos;t a barrier, SalingChat will{" "}
